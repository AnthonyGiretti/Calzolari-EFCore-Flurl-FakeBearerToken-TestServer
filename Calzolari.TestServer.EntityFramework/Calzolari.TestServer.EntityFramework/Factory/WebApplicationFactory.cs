...
//namespace Calzolari.TestServer.EntityFramework.Factory
//{
//    /// <summary>
...
//    public class WebApplicationFactory<TEntryPoint, TStartup> : IDisposable where TEntryPoint : class where TStartup : class
//    {
...
//        private List<WebApplicationFactory<TEntryPoint, TStartup>> _derivedFactories =
//            new List<WebApplicationFactory<TEntryPoint, TStartup>>();
...
//        /// </summary>
//        public Microsoft.AspNetCore.TestHost.TestServer Server
//        {
//            get
//            {
//                EnsureServer();
...
//        /// </summary>
//        public IReadOnlyList<WebApplicationFactory<TEntryPoint, TStartup>> Factories => _derivedFactories.AsReadOnly();
...
//        public WebApplicationFactory<TEntryPoint, TStartup> WithWebHostBuilder(Action<IWebHostBuilder> configuration) =>
//            WithWebHostBuilderCore(configuration);

//        internal virtual WebApplicationFactory<TEntryPoint, TStartup> WithWebHostBuilderCore(Action<IWebHostBuilder> configuration)
//        {
...
//                _server = (Microsoft.AspNetCore.TestHost.TestServer)_host.Services.GetRequiredService<IServer>();
//                return;
//            }
...
//                typeof(TStartup).Assembly.FullName,
...
//        {
//            if (typeof(TStartup).Assembly.EntryPoint == null)
//            {
//                throw new InvalidOperationException($"Resources.FormatInvalidAssemblyEntryPoint({typeof(TStartup).Name})");
//            }
...
//            if (!depsFile.Exists)
//            {
//                throw new InvalidOperationException($"Resources.FormatMissingDepsFile({depsFile.FullName}, {Path.GetFileName(depsFile.FullName)})");
//            }
//        }
...
//        protected virtual Microsoft.AspNetCore.TestHost.TestServer CreateServer(IWebHostBuilder builder) => new Microsoft.AspNetCore.TestHost.TestServer(builder);
...
//        private class DelegatedWebApplicationFactory : WebApplicationFactory<TEntryPoint, TStartup>
//        {
//            private readonly Func<IWebHostBuilder, Microsoft.AspNetCore.TestHost.TestServer> _createServer;
...
//                Func<IWebHostBuilder, Microsoft.AspNetCore.TestHost.TestServer> createServer,
...
//            protected override Microsoft.AspNetCore.TestHost.TestServer CreateServer(IWebHostBuilder builder) => _createServer(builder);
...
//            internal override WebApplicationFactory<TEntryPoint, TStartup> WithWebHostBuilderCore(Action<IWebHostBuilder> configuration)
//            {
